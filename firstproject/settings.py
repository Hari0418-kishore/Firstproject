...
SECRET_KEY = 'django-insecure-s=ri=(=8ditph(o3&#cq$--^3j#vezsfyn9e^kd)_m-2+!k6^y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['firstproject-ok0i.onrender.com', 'localhost', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'firstapp/templets')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
